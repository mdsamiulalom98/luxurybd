                            ...
                            <td>
                                <div class="button-list">
                                    ...
                                    <a href="{{route('campaign.edit',$value->id)}}" class="btn btn-xs btn-primary waves-effect waves-light"><i class="fe-edit-1"></i></a>
                                      <form method="post" action="{{route('campaign.duplicate')}}" class="d-inline">        
                                        @csrf
                                    <input type="hidden" value="{{$value->id}}" name="hidden_id">
                                    <button type="submit" class="btn btn-xs btn-success waves-effect waves-light change-confirm"><i class="fe-copy"></i></button></form>

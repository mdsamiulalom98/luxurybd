            ...
            <div class="h-100" data-simplebar>
                ...
                <div id="sidebar-menu">
                    ...
                    <ul id="side-menu">
                        ...
                        <li>
                            ...
                            <div class="collapse" id="sidebar-customers">
                                <ul class="nav-second-level">
                                    ...
                                    <li>
                                        <a href="{{ route('complains.index') }}"><i data-feather="minus"></i>
                                            Complain List</a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <!-- nav items -->
                        <li>
                            <a href="#sidebar-deposits" data-bs-toggle="collapse">
                                <i data-feather="users"></i>
                                <span> Deposit </span>
                                <span class="menu-arrow"></span>
                            </a>
                            <div class="collapse" id="sidebar-deposits">
                                <ul class="nav-second-level">
                                    <li>
                                        <a href="{{ route('deposit.all') }}">
                                            <i data-feather="minus"></i>
                                            All Deposit
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('deposit.pending') }}">
                                            <i data-feather="minus"></i>
                                            Pending Deposit
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('deposit.accepted') }}">
                                            <i data-feather="minus"></i>
                                            Accepted Deposit
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('deposit.return') }}">
                                            <i data-feather="minus"></i>
                                            Return Deposit
                                        </a>
                                    </li>
                        ...
                        <li>
                            ...
                            <div class="collapse" id="sidebar-withdraw">
                                <ul class="nav-second-level">
                                    ...
                                    <li>
                                        <a href="{{ route('withdraw.accepted') }}">
                                            <i data-feather="minus"></i>
                                            Accepted Withdraw
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('withdraw.return') }}">
                                            <i data-feather="minus"></i>
                                            Return Withdraw
                                        </a>
                                    </li>
                        ...
                        <li>
                            ...
                            <div class="collapse" id="siebar-sitesetting">
                                <ul class="nav-second-level">
                                    ...
                                    <li>
                                        <a href="{{ route('news.index') }}"><i data-feather="minus"></i>News</a>
                                    </li>
                                </ul>
                            </div>
                        </li>

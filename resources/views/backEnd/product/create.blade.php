                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                name="wholesale_price" value="{{ old('wholesale_price') }}" id="wholesale_price" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="wholesale_prices[]">
                                    ...
                                    <div class="row increment_control">
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    class="form-control @error('stock') is-invalid @enderror"
                                                    name="wholesale_prices[]" value="{{ old('wholesale_prices') }}" id="wholesale_prices">
                                                @error('wholesale_prices[]')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>

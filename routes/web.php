...
use App\Http\Controllers\Admin\NewsStikerController;
...
Route::group(['namespace' => 'Frontend', 'middleware' => ['ipcheck', 'check_refer']], function () {
    ...
    Route::post('site/mail-send', [FrontendController::class, 'mail_send'])->name('contact.mail_send');
    ...
    Route::post('/complain-store', [FrontendController::class, 'complain_store'])->name('complain_store');
    Route::get('/complain', [FrontendController::class, 'complain'])->name('complain');
...
Route::group(['prefix' => 'customer', 'namespace' => 'Frontend', 'middleware' => ['customer', 'ipcheck', 'check_refer']], function () {
    ...
    Route::post('/category-update', [CustomerController::class, 'category_update'])->name('customer.category_update');
    Route::get('deposit-create', [CustomerController::class, 'deposit_create'])->name('customer.deposit_create');
    Route::post('/deposit-store', [CustomerController::class, 'deposit_store'])->name('customer.deposit_store');
    Route::get('deposit-history', [CustomerController::class, 'deposit_history'])->name('customer.deposit_history');
    Route::get('withdraw-create', [CustomerController::class, 'withdraw_create'])->name('customer.withdraw_create');
    Route::post('/withdraw-store', [CustomerController::class, 'withdraw_store'])->name('customer.withdraw_store');
    Route::get('withdraw-history', [CustomerController::class, 'withdraw_history'])->name('customer.withdraw_history');
    Route::get('/members', [CustomerController::class, 'members'])->name('customer.members');
});
...
Route::group(['namespace' => 'Admin', 'middleware' => ['auth', 'lock', 'check_refer'], 'prefix' => 'admin'], function () {
    ...
    // newsstiker
    Route::get('news/manage', [NewsStikerController::class, 'index'])->name('news.index');
    Route::get('news/{id}/show', [NewsStikerController::class, 'show'])->name('news.show');
    Route::get('news/create', [NewsStikerController::class, 'create'])->name('news.create');
    Route::post('news/save', [NewsStikerController::class, 'store'])->name('news.store');
    Route::get('news/{id}/edit', [NewsStikerController::class, 'edit'])->name('news.edit');
    Route::post('news/update', [NewsStikerController::class, 'update'])->name('news.update');
    Route::post('news/inactive', [NewsStikerController::class, 'inactive'])->name('news.inactive');
    Route::post('news/active', [NewsStikerController::class, 'active'])->name('news.active');
    Route::post('news/destroy', [NewsStikerController::class, 'destroy'])->name('news.destroy');
    ...
    // backend complain route
    Route::get('complain/manage', [ComplainController::class, 'index'])->name('complains.index');
    Route::post('complain/destroy', [ComplainController::class, 'destroy'])->name('complains.destroy');
    ...
    Route::get('deposit/accepted', [DepositController::class, 'accepted'])->name('deposit.accepted');
    Route::get('deposit/return', [DepositController::class, 'return'])->name('deposit.return');
    ...
    Route::get('withdraw/pending', [WithdrawController::class, 'pending'])->name('withdraw.pending');
    Route::get('withdraw/accepted', [WithdrawController::class, 'accepted'])->name('withdraw.accepted');
    Route::get('withdraw/return', [WithdrawController::class, 'return'])->name('withdraw.return');
